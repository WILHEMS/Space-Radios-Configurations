...
if __name__ == "__main__":
    ...
    if not pi.connected:
        print("Not connected to space ... goodbye.")
        sys.exit()
        ...
        while True:
            ...
            while nrf.data_ready():
                ...
                if len(payload) == 8  and payload[0] == 0x01:
                    ...
                    print(f'Protocol: {values[0]}, image_64_decode: {values[1]}, humidity: {values[2]}')
                    print(type(values[1]))
                    ops=values[1].decode('utf-8')
                    print(type(ops))
                    print(ops)
                    image_ground = pybase64.b64decode(ops)
                    image_result = open('ground.jpg', 'wb')
                    image_result.write(image_ground)
