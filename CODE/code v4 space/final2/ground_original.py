...
try:
    ...
    while True:
        ...
        while nrf.data_ready():
            ...
            if payload:
                for i in range(1):
                    values = struct.unpack("ffffffffff", payload)
                    print(f'Accelerometer: {values[0],values[1],values[2]}')
                    print(f'Gyroscope: {values[3],values[4],values[5]}')
                    print(f'Magnetometer: {values[6],values[7],values[8]}')
                    print(f'Temperature: {values[9]}')
