    ...
    while True:
        ...
        while nrf.data_ready():
            ...
            if len(payload) == 9:
                ...
                os.system('python3 /home/pi/Documents/code/v6.py')
                sys.exit(0)
            elif len(payload) == 11:
                
                os.system('python3 /home/pi/Documents/code/take_camera.py')
                
                sys.exit(0)
            elif len(payload) == 10:
                os.system('python3 /home/pi/Documents/code/motion_data.py')
                
                sys.exit(0)
                
            elif len(payload) == 14:
                os.system('python3 /home/pi/Documents/code/voltages.py')
                
                sys.exit(0)
                
            elif len(payload) == 17:
                #os.system('python3 /home/pi/Documents/code/gps1.py')
                os.system('python3 /home/pi/Documents/code/gps.py')
                
                sys.exit(0)
            elif len(payload) == 4:
                #os.system('python3 /home/pi/Documents/code/gps1.py')
                os.system('python3 /home/pi/Documents/code/within_range.py')
